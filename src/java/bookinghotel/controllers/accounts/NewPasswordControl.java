    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (check) {
                ...
                request.setAttribute("mess5", "Password must be 8-30 characters and include at least 1 uppercase letter, 1 number and 1 special character!");
                UserDAO userDao = new UserDAO();
                UserDTO userDto = userDao.getUserByUserName(username);
                request.setAttribute("account", userDto);
                request.getRequestDispatcher("newPassword.jsp").forward(request, response);
            ...
            request.setAttribute("mess6", "Reset Password Fail!!");
            request.getRequestDispatcher("login1.jsp").forward(request, response);
        }
