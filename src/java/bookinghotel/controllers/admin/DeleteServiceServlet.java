...
public class DeleteServiceServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            OrderServiceDAO orDAo = new OrderServiceDAO();
            if(orDAo.deleteService(id)){
                request.setAttribute("SERVICE_CHECK", "Delete Successful!");
                request.getRequestDispatcher("LoadServices").forward(request, response);
            }else{
                request.getRequestDispatcher("LoadServices").forward(request, response);
            }
        } catch (Exception e) {
            request.setAttribute("SERVICE_CHECK", "Delete Fail!");
                request.getRequestDispatcher("LoadServices").forward(request, response);
        }
        }
